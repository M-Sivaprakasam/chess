...
function changeDirection(queen, move) {
    var direction = queen.direction;
    switch (direction) {
        case 'W':
        case 'w':
            moveForward(queen.position, direction, move);
            break;
        case 'E':
        case 'e':
            moveBackward(queen.position, direction, move);
            break;
        case 'N':
        case 'n':
            moveright(queen.position, direction, move);
            break;
        case 's':
        case 'S':
            moveleft(queen.position, direction, move);
            break;
    }
}
